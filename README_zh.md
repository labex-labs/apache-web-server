...
<p align="center">
  <a href="https://labex.io/zh/courses/apache-web-server">
    <img src="https://course-cover.labex.io/apache-web-server.png?lang=zh" alt="Apache Web 服务器">
  </a>
</p>

学习 Apache Web Server。本模块涵盖安装 Apache HTTPD、启用用户目录、虚拟主机配置、使用 Htaccess 文件、URL 重写。您将通过实践实验室和真实世界的挑战掌握这些基本的 Linux 技能。

[在 LabEx 开始课程](https://labex.io/zh/courses/apache-web-server)
